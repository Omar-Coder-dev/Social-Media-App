...
gender: Zod.string().nonempty("Gender is required").regex(/^(male|female)$/, "Invalid gender"),
    ...
    message: "Password and Confirm Password must be the same", path: ["rePassword"]
  })
